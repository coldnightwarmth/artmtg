...
assert(page.includes("../app.js?v=cardnft-377"), "Poncho page has a stale app cache key");
assert(page.includes("../styles.css?v=cardnft-154"), "Poncho page has a stale style cache key");
